...
/* package shooter-0.0.1 */
#ifndef VERSION_shooter
#define VERSION_shooter "0.0.1"
#endif /* VERSION_shooter */
#ifndef MIN_VERSION_shooter
#define MIN_VERSION_shooter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 1)
#endif /* MIN_VERSION_shooter */
...
#define CURRENT_COMPONENT_ID "shooter-0.0.1-IaacNID0dMp2KOQOqZYCSm-glosstest"
